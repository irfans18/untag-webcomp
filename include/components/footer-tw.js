...
footerTemplate.innerHTML = `
   <footer class="mt-20 text-white" style="background-color: #c21c14">
      <div class="pt-12 pb-16 mx-12 2xl:px-48">
         <div class="flex flex-wrap lg:flex-nowrap">
            <div class="max-w-xs py-2">
               <div class="mb-2">
                  <!-- <img src="img/untag.png" width="120" alt="Logo UNTAG" /> -->
                  <h3 class="text-xl font-bold">
                     Universitas 17
                     <br />
                     <b>Agustus 1945 Samarinda</b>
                  </h3>
                  <h4 class="mt-10 text-xs font-medium block">
                     Jl. Ir. H. Juanda, No.80 Universitas 17 Agustus 1945,
                     Air Hitam, Kec. Samarinda Ulu, Kota Samarinda,
                     Kalimantan Timur 75123
                  </h4>
                  <h4 class="py-1 text-xs font-medium">
                     Telp/Fax : 0541 743390
                  </h4>
                  <h4 class="text-xs font-medium">
                     Email : webmaster@untag-smd.ac.id
                  </h4>
               </div>
               <div class="my-8">
                  <h4 class="text-xs font-bold">Sosial Media</h4>
                  <div
            ...
            >
               ...
               <div class="w-40 py-2">
                  ...
                  >
                     ...
                     <li>
                        <a href="">Lab. Pertanian</a>
                     </li>
                     <li>
                        <a href="">Lab. Teknik</a>
                     </li>
                     <li>
                        <a href="">Lab. Manajemen</a>
                     </li>
                     <li>
                        <a href="">Lab. Akuntansi</a>
                     </li>
                     <li>
                        <a href="">Lab. Hukum</a>
                     </li>
                     <li>
                        <a href="">Lab. Psikologi</a>
                     </li>
                  </nav>
               </div>
               <div class="w-48 py-2">
      ...
      <div class="border-color mx-auto">
         <div>
            <div
               style="background-color: #751313"
               class="py-3.5 lg:px-40 flex flex-col lg:flex-row items-center space-y-5 lg:space-y-0"
            >
               <nav
